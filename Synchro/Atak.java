...
void oblicz(int flag) {//0 - domyœlnie, 1 - na podstawie planowanego czasu dotarcia, 2 - na podstawie planownaego czasu wyruszenia
	if (flag == 0) {
...
void ustaw_pol() {
	oblicz(0);
	//System.out.println("powinno dodaæ pochodzenie do celu");
	cel.dodaj_polaczona(pochodzenie);
	//System.out.println("powinno dodaæ cel do pochodzenia");
